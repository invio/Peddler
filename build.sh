...
dotnet build ./test/Peddler.Tests -c Release -f net451

mono \
./test/Peddler.Tests/bin/Release/net451/*/dotnet-test-xunit.exe \
./test/Peddler.Tests/bin/Release/net451/*/Peddler.Tests.dll

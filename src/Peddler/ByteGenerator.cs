...
namespace Peddler {
    ...
    /// <summary>
    ///   A generator for numbers of type <see cref="System.Byte" />. Depending on the
    ///   constructor used, the generator can either utilize a range of all possible
    ///   <see cref="System.Byte" /> values or a constrained, smaller range.
    /// </summary>
    /// <remarks>
    ///   The range of possible <see cref="System.Byte" /> values will always be contiguous.
    /// </remarks>
    public class ByteGenerator : IntegralGenerator<Byte> {
        ...
        ///   <see cref="System.Byte" /> values that range from 0 (inclusively) to
        ///   <see cref="System.Byte.MaxValue" /> (exclusively).
        /// </summary>
        ...
        /// <summary>
        ///   Instantiates an <see cref="ByteGenerator" /> that can create
        ///   <see cref="System.Byte" /> values that range from <paramref name="low" />
        ///   (inclusively) to <see cref="System.Byte.MaxValue" /> (exclusively).
        /// </summary>
        /// <param name="low">
        ///   The inclusive, lower <see cref="System.Byte" /> boundary for this generator.
        /// </param>
        ...
        /// </param>
        /// <param name="high">
        ///   The exclusive, upper <see cref="System.Byte" /> boundary for this generator.
        /// </param>

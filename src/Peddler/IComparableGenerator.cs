...
namespace Peddler {
    ...
    public interface IComparableGenerator<T> {
        ...
        ///   boundary for any value that this <see cref="IComparableGenerator{T}"/>
        ///   may generate.
        /// </param>
        /// <returns>
        ...
        ///   Thrown when this <see cref="IComparableGenerator{T}"/> is unable to
        ...
        /// </summary>
        /// <remarks>
        ///   The range of values generated by this <see cref="IComparableGenerator{T}"/>
        ...
        ///   <paramref name="other" />. In that case, the value returned will always be less
        ///   than <paramref name="other" />.
        /// </remarks>
        /// <param name="other">

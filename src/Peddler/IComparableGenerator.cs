...
namespace Peddler {
    ...
    /// that are greater than, less than, or equal to provided values of <typeparamref name="T"/>.
    /// </summary>
    public interface IComparableGenerator<T> {
        ...
        /// implementation may have a lower boundary that is greater than <paramref name="other" />.
        /// In that case, the value returned will always be greater than <paramref name="other" />.
        /// </remarks>
        /// <param name="other">
        ...
        /// <remarks>
        /// The range of values generated by this <see cref="T:Peddler.IComparableGenerator`1"/>
        /// implementation may have an upper boundary that is less than <paramref name="other" />.
        /// In that case, the value returned will always be less than <paramref name="other" />.
        /// </remarks>
        /// <param name="other">

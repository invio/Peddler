...
namespace Peddler {
    ...
    /// <summary>
    ///   A generator for numbers of type <see cref="System.Int16" />. Depending on the
    ///   constructor used, the generator can either utilize a range of all possible
    ///   <see cref="System.Int16" /> values or a constrained, smaller range.
    /// </summary>
    /// <remarks>
    ///   The range of possible <see cref="System.Int16" /> values will always be contiguous.
    /// </remarks>
    public class Int16Generator : IntegralGenerator<Int16> {
        ...
        ///   <see cref="System.Int16" /> values that range from 0 (inclusively) to
        ///   <see cref="System.Int16.MaxValue" /> (exclusively).
        /// </summary>
        ...
        /// <summary>
        ///   Instantiates an <see cref="Int16Generator" /> that can create
        ///   <see cref="System.Int16" /> values that range from <paramref name="low" />
        ///   (inclusively) to <see cref="System.Int16.MaxValue" /> (exclusively).
        /// </summary>
        /// <param name="low">
        ///   The inclusive, lower <see cref="System.Int16" /> boundary for this generator.
        /// </param>
        ...
        /// </param>
        /// <param name="high">
        ///   The exclusive, upper <see cref="System.Int16" /> boundary for this generator.
        /// </param>

...
namespace Peddler {
    ...
    /// <summary>
    ///   A generator for numbers of type <see cref="System.Int64" />. Depending on the
    ...
    /// </summary>
    /// <remarks>
    ///   The range of possible <see cref="System.Int64" /> values will always be contiguous.
    /// </remarks>
    public class Int64Generator : IntegralGenerator<Int64> {
        ...
        ///   <see cref="System.Int64" /> values that range from 0 (inclusively) to
        ///   <see cref="System.Int64.MaxValue" /> (exclusively).
        /// </summary>
        ...
        /// <summary>
        ///   Instantiates an <see cref="Int64Generator" /> that can create
        ///   <see cref="System.Int64" /> values that range from <paramref name="low" />
        ///   (inclusively) to <see cref="System.Int64.MaxValue" /> (exclusively).
        /// </summary>
        /// <param name="low">
        ///   The inclusive, lower <see cref="System.Int64" /> boundary for this generator.
        /// </param>
        ...
        /// </param>
        /// <param name="high">
        ///   The exclusive, upper <see cref="System.Int64" /> boundary for this generator.
        /// </param>

...
namespace Peddler {
    ...
    /// <summary>
    ///   A generator for numbers of type <see cref="System.UInt32" />. Depending on the
    ///   constructor used, the generator can either utilize a range of all possible
    ///   <see cref="System.UInt32" /> values or a constrained, smaller range.
    /// </summary>
    /// <remarks>
    ///   The range of possible <see cref="System.UInt32" /> values will always be contiguous.
    /// </remarks>
    public class UInt32Generator : IntegralGenerator<UInt32> {
        ...
        ///   <see cref="System.UInt32" /> values that range from 0 (inclusively) to
        ///   <see cref="System.UInt32.MaxValue" /> (exclusively).
        /// </summary>
        ...
        /// <summary>
        ///   Instantiates an <see cref="UInt32Generator" /> that can create
        ///   <see cref="System.UInt32" /> values that range from <paramref name="low" />
        ///   (inclusively) to <see cref="System.UInt32.MaxValue" /> (exclusively).
        /// </summary>
        /// <param name="low">
        ///   The inclusive, lower <see cref="System.UInt32" /> boundary for this generator.
        /// </param>
        ...
        /// </param>
        /// <param name="high">
        ///   The exclusive, upper <see cref="System.UInt32" /> boundary for this generator.
        /// </param>
